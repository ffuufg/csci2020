...
public class DataSource {
	...
	private static ObservableList<StudentRecord> marks = FXCollections.observableArrayList();
	
	public static ObservableList<StudentRecord> setAllMarks() {
	...
	public static void addRecord(StudentRecord s) {
		marks.add(s);
	}
